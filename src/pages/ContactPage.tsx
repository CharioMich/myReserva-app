    ...
    <>
      <section className="flex flex-col p-5 space-y-6 justify-center items-center bg-gradient-to-r from-pink-400 to-orange-100 min-h-[100vh]">
        ...
        <div className="flex flex-col items-center space-y-2 text-center">
          <div className="text-md text-gray-600 "><p className="flex flex-row items-center space-x-1"><Mail /> Email:&nbsp;<a href="mailto:support@myreserva.com" className="text-blue-500 hover:underline">support@myreserva.com</a></p> </div>
          <div className="text-md text-gray-600 "><p className="flex flex-row items-center space-x-1"><Phone /> Phone:&nbsp;<a href="tel:+1234567890" className="text-blue-500 hover:underline">+30 123-4567-890</a></p> </div>
          <div className="text-md text-gray-600 "><p className="flex flex-row items-center space-x-1"><MapPin /> Location: 123 Vouliagmenis Av. Athens, Greece</p> </div>
        </div>
